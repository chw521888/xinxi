        ...
        jQuery('.sidebar-collapse').click(function () {
            ...
            if (is_mobile && !(is_mini_menu)) {
                ...
                if (collapsed) {
					...
					//$("#main-content iframe").css("width", $(document).width() - 260 + "px").css("height", $(document).height() - 120 + "px");
                }
                else {
                    ...
                    collapsed = true;
                    $.cookie('mini_sidebar', '1');
					//$("#main-content iframe").css("width", $(document).width() - 50 + "px").css("height", $(document).height() - 120 + "px");
                    handleMobileSidebar();
                }
            }
                ...
                if (collapsed) {
                    ...
                    collapsed = false;
                    $.cookie('mini_sidebar', '0');
					$("#main-content iframe").css("width", $(document).width() - 250 + "px").css("height", $(document).height() - 120 + "px");
                }
                else {
                    /* For Navbar */
                    jQuery('.navbar-brand').addClass("mini-menu");
