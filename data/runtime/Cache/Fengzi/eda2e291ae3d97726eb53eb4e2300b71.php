		...
		<div class="child_paint">
			<div class="warp">
				...
				<div class="list_item_box paint clearfix">
					<div class="list_city_ti">赛场风姿</div>
					<a href="<?php echo U('archives/index_arctype/index',array('t_id'=>73));?>" class="up">我要上传</a>
					<div class="seach">
						<form action="?" method="get">
							...
							<input name="keywords" type="text" class="seach_txt" value="" placeholder="请输入ID、昵称">
					        ...
					        <div class="brand-list">
					            <div class="brand-bd cle" id="brand-waterfall">
					                ...
					                <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="item">
					                    ...
					                    <div class="brand_txt">
					                    	<div class="num_z post_zan_fengzi"  onclick="post_zan_fengzi(<?php echo ($v["id"]); ?>,0);"><?php echo ($v["num_view"]); ?></div>
					                    	<div class="data">
