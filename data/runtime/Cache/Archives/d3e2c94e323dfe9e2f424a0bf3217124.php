...
<!--<div class="logo9" style="background: url('<?php echo ($info["pic_banner"]); ?>') center no-repeat;"></div>-->
<!--导航              开始-->
        <div class="menu">
...
<?php $menu_son_list = get_level_channel(); ?>
<div class="z-content">
	<div class="z-content-1">
        <ul class="z-nav">
        <?php if(is_array($menu_son_list)): foreach($menu_son_list as $key=>$v): ?><li class="z-nav-l <?php if($v['is_now_parent'] == true): ?>active<?php endif; ?>">
                <a href="<?php echo ($v["url"]); ?>"><?php echo ($v["typename"]); ?></a>
                <p></p>
            </li><?php endforeach; endif; ?>
        </ul>
   	</div>
...
<div class="main">
     <span class="span1">
        <ul class="border-bottom">
            <li><?php echo (htmlspecialchars_decode($info["content"])); ?></li>
        </ul>
    </span>
</div>
