    ...
    $(".right_eq").show();        
		...
		<div class="warp">
			...
			<div class="list_item_box">
				<div class="list_city_ti">少儿直通车</div>
				<div class="seach" style="line-height: 50px; width:auto;"><a href="<?php echo U('Archives/IndexArctype/index',array('t_id'=>76));?>">更多>></a></div>
			</div>
			
			<ul class="list_city_team clearfix">
			<?php $list = get_article(array('arctype_id'=>76,'limit'=>20)); ?>
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
					<a href="<?php echo ($v["url"]); ?>">
						<div><img src="<?php echo ($v["pic"]); ?>" alt="" /></div>
						<div class="txt">
							<h4><?php echo ($v["title"]); ?></h4>
							<span><i>表演者：</i><?php echo ($v["resume"]); ?></span>
						</div>
					</a>
				</li><?php endforeach; endif; ?>
			</ul>
			...
			<div class="list_item_box">
				<div class="list_city_ti">成人直通车</div>
				<div class="seach" style="line-height: 50px; width:auto;"><a href="<?php echo U('Archives/IndexArctype/index',array('t_id'=>77));?>">更多>></a></div>
			</div>
			
			<ul class="list_city_team clearfix">
			<?php $list = get_article(array('arctype_id'=>77,'limit'=>20)); ?>
			<?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
					<a href="<?php echo ($v["url"]); ?>">
						<div><img src="<?php echo ($v["pic"]); ?>" alt="" /></div>
						<div class="txt">
