...
<script language="javascript" src="/template/Index/Common/html5media/html5media.min.js"></script>
...
<!--<div class="logo4" style="background: url('<?php echo ($info["pic_banner"]); ?>') center no-repeat;"></div>-->
<!--导航              开始-->
        <div class="menu">
...
<div class="main">
    <div>
        <ul class="column">
            <li class="fy">您现在的位置：<a href="/">首页</a> > <a href="javascript:history.go(-1);"><?php echo (show_l2_name($info["location_id"])); ?></a> >  <?php echo ($info["show_name"]); ?></li>
        </ul>
    </div>
    <ul class="video-name"><li><?php echo ($info["show_name"]); ?></li></ul>
    <ul class="video1">
        <li style="text-align:center">
        <?php if($info['video2'] != ''): ?><embed src="http://yuntv.letv.com/bcloud.swf" allowFullScreen="true" quality="high"  width="1000" height="700" align="middle" allowScriptAccess="always" flashvars="uu=uilcwncrnf&vu=<?php echo ($info["video2"]); ?>&pu=1348d387b0&auto_play=0&gpcflag=1&width=1000&height=700" type="application/x-shockwave-flash"></embed>
        <?php else: ?>
        <video id="hellofitvideo" width="1000" height="700" controls="controls" src="<?php echo ($info["video"]); ?>" poster="<?php echo ($info["pic"]); ?>">
<source src="<?php echo ($info["video"]); ?>" type='video/mp4; codecs="avc1.42E01E,MP4a.40.2"' />
        ...
        <li class="gename">
                ...
                <span class="votes">
                当前已获得 <p><?php echo ($info["num_vote_show"]); ?></p> 票
                </span>
            <input onclick="post_vote(<?php echo ($info["id"]); ?>);" type="button" value="投  票" class="obutton"/>
            <!--<input type="button" value="往期视频" class="gbutton"/>-->
        </li>
        <li>
            <table border="1" cellpadding="0" cellspacing="0">
                <tr>
                    <th>街道名称</th>
                    <td><?php echo (show_l2_name($info["location_id"])); ?></td>
                    <th>参赛人数</th>
                    <td><?php echo (show_str($info2["num_competition"])); ?></td>
                </tr>
                <tr>
                    <th>社区名称</th>
                    <td><?php echo ($info2["community_name"]); ?></td>
                    <th>节目名称</th>
                    <td><?php echo ($info["show_name"]); ?></td>
                </tr>
                <tr>
                    <th>队伍名称</th>
                    <td><?php echo ($info2["name"]); ?></td>
                    <th>平均年龄</th>
                    <td><?php echo (show_str($info2["age"])); ?></td>
                </tr>
            </table>
        </li>
    </ul>
    ...
    <ul style="width:1000px; margin:auto;">
        <li style="padding:10px; padding-bottom:20px; line-height:25px;"><?php echo (make_textarea($info2["resume"])); ?></li>
    </ul>
    <?php } ?>
    <!--
    <ul class="team-main">
        <li class="experience">
            ...
            <p><span>成长经历</span><?php echo ($info2["content_1"]); ?></p>
            <span class="exp"><img src="<?php echo ($info2["content_pic_1"]); ?>" width="133" height="133" alt=""/></span>
        </li>
    </ul>
    <ul class="team-main">
        <li class="personnel">
            <span class="list-imgr"></span>
            <p><span>团队人员组成</span><?php echo ($info2["content_2"]); ?></p>
            <span class="expl"><img src="<?php echo ($info2["content_pic_2"]); ?>" width="133" height="133" alt=""/></span>
        </li>
    </ul>
    <ul class="team-main">
        <li class="experience">
            <span class="list-img"></span>
            <p><span>获得奖项</span><?php echo ($info2["content_3"]); ?></p>
            <span class="exp"><img src="<?php echo ($info2["content_pic_3"]); ?>" width="133" height="133" alt=""/></span>
        </li>
    </ul>
    <ul class="team-main">
        <li class="personnel">
            <span class="list-imgr"></span>
            <p><span>参加过重大活动或比赛</span><?php echo ($info2["content_4"]); ?></p>
            <span class="expl"><img src="<?php echo ($info2["content_pic_4"]); ?>" width="133" height="133" alt=""/></span>
        </li>
    </ul>
    <ul class="team-main">
        <li class="experience">
            <span class="list-img"></span>
            <p><span>节目创作故事</span><?php echo ($info2["content_5"]); ?></p>
            <span class="exp"><img src="<?php echo ($info2["content_pic_5"]); ?>" width="133" height="133" alt=""/></span>
        </li>
    </ul>
    -->
</div>
