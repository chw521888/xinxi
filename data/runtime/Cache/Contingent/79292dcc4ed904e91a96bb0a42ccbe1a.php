...
<!--导航              开始-->
	...
	<div class="screen_box">
		<ul class="screen w1000">
			<li>
				<span>赛程：</span>
				<p id="sel_item">
					<a <?php if(($_GET['stage']) == ""): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>'','location_id'=>$_GET['location_id'],'type'=>$_GET['type']));?>">全部</a>
					<a <?php if(($_GET['stage']) == "3"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>3,'location_id'=>$_GET['location_id'],'type'=>$_GET['type']));?>">社区赛</a>
					<a <?php if(($_GET['stage']) == "2"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>2,'location_id'=>$_GET['location_id'],'type'=>$_GET['type']));?>">街道赛</a>
					<a <?php if(($_GET['stage']) == "1"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>1,'location_id'=>$_GET['location_id'],'type'=>$_GET['type']));?>">城市赛</a>
				</p>
				<div class="clear"></div>
			</li>
			<li>
				<span>赛区：</span>
				<p id="sel_item">
					<a <?php if(($_GET['location_id']) == ""): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>'','type'=>$_GET['type']));?>">全部</a>
					<?php if(is_array($location_list)): foreach($location_list as $key=>$v): ?><a <?php if(($_GET['location_id']) == $v['id']): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>$v['id'],'type'=>$_GET['type']));?>"><?php echo ($v["name"]); ?></a><?php endforeach; endif; ?>
				</p>
				<div class="clear"></div>
			</li>
			<li>
				<span>内容：</span>
				<p id="sel_item">
					<a <?php if(($_GET['type']) == ""): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>$_GET['location_id'],'type'=>''));?>">全部</a>
					<a <?php if(($_GET['type']) == "1"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>$_GET['location_id'],'type'=>1));?>">视频</a>
					<a <?php if(($_GET['type']) == "2"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>$_GET['location_id'],'type'=>2));?>">花絮</a>
					<a <?php if(($_GET['type']) == "3"): ?>class="active"<?php endif; ?> href="<?php echo U('index',array('stage'=>$_GET['stage'],'location_id'=>$_GET['location_id'],'type'=>3));?>">照片</a>
				</p>
				<div class="clear"></div>
			</li>
		</ul>
	...
	<?php if($_GET['type'] == 1 or $_GET['type'] == ''): ?><div class="s_ssjj_viode">
			...
			<div class="s_sj_list">
				...
				<div class="s_sj_more"><a href="<?php echo U('index_more',array('type'=>1,'location_id'=>$_GET['location_id'],'stage'=>$_GET['stage']));?>">更多>></a></div>
			</div>
		</div><?php endif; ?>
	<?php if($_GET['type'] == 2 or $_GET['type'] == ''): ?><div class="s_ssjj_viode">
			<div><img src="/template/Index/Common/images/s_ssjj_it_01.jpg"/></div>
			<div class="s_sj_list">
				<ul>
					<?php if(is_array($list2)): foreach($list2 as $key=>$v): ?><li>
				...
				<div class="s_sj_more"><a href="<?php echo U('index_more',array('type'=>2,'location_id'=>$_GET['location_id'],'stage'=>$_GET['stage']));?>">更多>></a></div>
			</div>
		</div><?php endif; ?>
	<?php if($_GET['type'] == 3 or $_GET['type'] == ''): ?><div class="s_ssjj_viode">
			<div><img src="/template/Index/Common/images/s_ssjj_it_02.jpg"/></div>
			<div class="s_sj_list">
				<ul>
					<?php if(is_array($list3)): foreach($list3 as $key=>$v): ?><li>
						<a href="<?php echo U('Contingent/IndexShow/index_xiu_show',array('id'=>$v['id']));?>">
							<img src="<?php echo ($v["pic"]); ?>"  width="240" height="170"/>
							<span><?php echo (show_location_name($v["location_id"])); ?></span>
							<i><?php echo ($v["title"]); ?></i>
				...
				<div class="s_sj_more"><a href="<?php echo U('index_more',array('type'=>3,'location_id'=>$_GET['location_id'],'stage'=>$_GET['stage']));?>">更多>></a></div>
			</div>
		</div><?php endif; ?>
	</div>
<div class="footer">
