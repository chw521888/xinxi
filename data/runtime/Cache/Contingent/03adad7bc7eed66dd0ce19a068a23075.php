...
<script type="text/javascript" src="/template/Index/NewCommon/js/ScrollPic.js" ></script>
<link rel="stylesheet" href="/template/Index/NewCommon/css/lightbox.min.css">    

    <div class="warp">
      <div class="list_item_box">
        <div class="list_city_ti"><?php echo ($info["name"]); ?></div>
      </div>
      
      
      <ul class="list_city_team clearfix">
      <?php if(is_array($list)): foreach($list as $key=>$v): ?><li>
          <a href="<?php echo ($v["pic"]); ?>" data-lightbox="example-set" data-title="<?php echo ($v["title"]); ?>">
...
<script type="text/javascript" src="/template/Index/NewCommon/js/lightbox-plus-jquery.min.js" ></script>
