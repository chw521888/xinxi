...
<div class="main">
    <div>
        <ul class="border-bottom">
            <li class="fy1">当前位置：<a href="/">首页</a> &gt; <a href="#">详情</a> <span>&lt;<a href="javascript:history.go(-1);">返回列表</a></span></li>
    ...
    <div>
        ...
        <ul class="border-bottom">
          <li class="fz14"><?php echo (htmlspecialchars_decode($info["content"])); ?>
          <?php if($info['jianjie'] != ''): ?><div style="width: 100%; text-align: center;">
          <video width="640" height="600" controls autobuffer>
		    <source src="<?php echo ($info["jianjie"]); ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
		</video>
		</div><?php endif; ?>
</li>
        </ul>
