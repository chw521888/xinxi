...
<div class="wrap jj">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Contingent/Show/index_stage_0');?>">节目管理</a></li>
			<li><a href="<?php echo U('Contingent/Show/add_show_stage_0');?>">添加节目</a></li>
		</ul>
        ...
        <div class="table-actions">
            ...
            <!-- Think 系统列表组件开始 -->
<table id="dataTable" class="table table-hover table-bordered table-list  table-hover" cellpadding=0 cellspacing=0 ><thead><tr><th data-field="id"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index_stage_0')" title="按照ID             <?php echo ($sortType); ?> ">ID             <?php if(($order) == "id"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="contingent_id"><a href="javascript:sortBy('contingent_id','<?php echo ($sort); ?>','index_stage_0')" title="按照队伍名称             <?php echo ($sortType); ?> ">队伍名称             <?php if(($order) == "contingent_id"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="show_name"><a href="javascript:sortBy('show_name','<?php echo ($sort); ?>','index_stage_0')" title="按照作品名称             <?php echo ($sortType); ?> ">作品名称             <?php if(($order) == "show_name"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="video2"><a href="javascript:sortBy('video2','<?php echo ($sort); ?>','index_stage_0')" title="按照乐视ID             <?php echo ($sortType); ?> ">乐视ID             <?php if(($order) == "video2"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="pic"><a href="javascript:sortBy('pic','<?php echo ($sort); ?>','index_stage_0')" title="按照缩略图             <?php echo ($sortType); ?> ">缩略图             <?php if(($order) == "pic"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="stage"><a href="javascript:sortBy('stage','<?php echo ($sort); ?>','index_stage_0')" title="按照阶段             <?php echo ($sortType); ?> ">阶段             <?php if(($order) == "stage"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="num_vote"><a href="javascript:sortBy('num_vote','<?php echo ($sort); ?>','index_stage_0')" title="按照实际得票数                 <?php echo ($sortType); ?> ">实际得票数                 <?php if(($order) == "num_vote"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="num_vote_show"><a href="javascript:sortBy('num_vote_show','<?php echo ($sort); ?>','index_stage_0')" title="按照展示票数                 <?php echo ($sortType); ?> ">展示票数                 <?php if(($order) == "num_vote_show"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="is_win"><a href="javascript:sortBy('is_win','<?php echo ($sort); ?>','index_stage_0')" title="按照是否晋级<?php echo ($sortType); ?> ">是否晋级<?php if(($order) == "is_win"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr></thead><?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr ><td><?php echo ($list["id"]); ?></td><td><?php echo (show_ca_name2($list["contingent_id"])); ?></td><td><?php echo ($list["show_name"]); ?></td><td><?php echo ($list["video2"]); ?></td><td><?php echo (show_img($list["pic"])); ?></td><td><?php echo (show_stage($list["stage"])); ?></td><td><?php echo ($list["num_vote"]); ?></td><td><?php echo ($list["num_vote_show"]); ?></td><td><?php echo (show_is_win($list["is_win"])); ?></td><td><a href="javascript:edit('<?php echo ($list["id"]); ?>','edit_show_stage_0')"><?php echo check_action_competence("<i class='fa fa-edit'></i>",$list["is_system"],"edit");?></a>&nbsp;</td></tr><?php endforeach; endif; else: echo "" ;endif; ?><tfoot><tr><th data-field="id"><a href="javascript:sortBy('id','<?php echo ($sort); ?>','index_stage_0')" title="按照ID             <?php echo ($sortType); ?> ">ID             <?php if(($order) == "id"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="contingent_id"><a href="javascript:sortBy('contingent_id','<?php echo ($sort); ?>','index_stage_0')" title="按照队伍名称             <?php echo ($sortType); ?> ">队伍名称             <?php if(($order) == "contingent_id"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="show_name"><a href="javascript:sortBy('show_name','<?php echo ($sort); ?>','index_stage_0')" title="按照作品名称             <?php echo ($sortType); ?> ">作品名称             <?php if(($order) == "show_name"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="video2"><a href="javascript:sortBy('video2','<?php echo ($sort); ?>','index_stage_0')" title="按照乐视ID             <?php echo ($sortType); ?> ">乐视ID             <?php if(($order) == "video2"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="pic"><a href="javascript:sortBy('pic','<?php echo ($sort); ?>','index_stage_0')" title="按照缩略图             <?php echo ($sortType); ?> ">缩略图             <?php if(($order) == "pic"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="stage"><a href="javascript:sortBy('stage','<?php echo ($sort); ?>','index_stage_0')" title="按照阶段             <?php echo ($sortType); ?> ">阶段             <?php if(($order) == "stage"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="num_vote"><a href="javascript:sortBy('num_vote','<?php echo ($sort); ?>','index_stage_0')" title="按照实际得票数                 <?php echo ($sortType); ?> ">实际得票数                 <?php if(($order) == "num_vote"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="num_vote_show"><a href="javascript:sortBy('num_vote_show','<?php echo ($sort); ?>','index_stage_0')" title="按照展示票数                 <?php echo ($sortType); ?> ">展示票数                 <?php if(($order) == "num_vote_show"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th data-field="is_win"><a href="javascript:sortBy('is_win','<?php echo ($sort); ?>','index_stage_0')" title="按照是否晋级<?php echo ($sortType); ?> ">是否晋级<?php if(($order) == "is_win"): ?><img src="/jtjk/public/images/<?php echo ($sortImg); ?>.gif" width="12" height="17" border="0" align="absmiddle"><?php endif; ?></a></th><th >操作</th></tr></tfoot></table>
<!-- Think 系统列表组件结束 -->
