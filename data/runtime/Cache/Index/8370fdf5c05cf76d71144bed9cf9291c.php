...
<div class="main">
    ...
    <ul class="video1">
        ...
        <?php if($info['video2'] != ''): ?><embed src="http://yuntv.letv.com/bcloud.swf" allowFullScreen="true" quality="high"  width="640" height="480" align="middle" allowScriptAccess="always" flashvars="uu=uilcwncrnf&vu=<?php echo ($info["video2"]); ?>&pu=1348d387b0&auto_play=0&gpcflag=1&width=640&height=480" type="application/x-shockwave-flash"></embed>
        <?php else: ?>
        <video id="hellofitvideo" width="995" height="562" controls="controls" src="<?php echo ($info["video"]); ?>" poster="<?php echo ($info["pic"]); ?>">
