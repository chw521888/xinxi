...
<!--banner    开始-->
        <div class="warp">
           	<?php if($stage == 1): ?><div class="banner"><img src="<?php echo C('HUIHUA_1_BANNER');?>"></div><?php endif; ?>
			<?php if($stage == 2): ?><div class="banner"><img src="<?php echo C('HUIHUA_2_BANNER');?>"></div><?php endif; ?>
			<?php if($stage == 3): ?><div class="banner"><img src="<?php echo C('HUIHUA_3_BANNER');?>"></div><?php endif; ?>
			<?php if($stage == 4): ?><div class="banner"><img src="<?php echo C('HUIHUA_4_BANNER');?>"></div><?php endif; ?>
        </div>
        <!--banner    End-->
...
$(".ri_gb").hover(function(){            
    $(".right_eq").show();        
		...
		<div class="child_paint">
			<div class="warp">

				<?php  ?>
				<div class="list_item_box paint clearfix">
					<div class="list_city_ti">儿童绘画赛</div>
					...
					<div class="seach">
			            ...
			            <input type="hidden" value="<?php echo ($_GET['stage']); ?>" name="stage" />
							<input name="keywords" type="text" class="seach_txt" value="<?php echo ($_GET['keywords']); ?>" placeholder="请输入ID、昵称">
							<input type="submit" class="seach_but" name="" value=" ">
						</form>
					</div>
				</div>
				...
				<div class="match_list_top">
					<div class="match_top clearfix">
						<a href="<?php echo U('archives/index_arctype/index',array('t_id'=>72));?>">我要参赛</a>
						<?php if($stage == 1): ?><img src="<?php echo C('HUIHUA_1_IMG');?>"><?php endif; ?>
						<?php if($stage == 2): ?><img src="<?php echo C('HUIHUA_2_IMG');?>"><?php endif; ?>
						<?php if($stage == 3): ?><img src="<?php echo C('HUIHUA_3_IMG');?>"><?php endif; ?>
						<?php if($stage == 4): ?><img src="<?php echo C('HUIHUA_4_IMG');?>"><?php endif; ?>
					</div>
					        ...
					        <div class="brand-list">
					            <div class="brand-bd cle" id="brand-waterfall">
					                ...
					                <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="item">
					                    ...
					                    <div class="brand_txt">
					                    	<a class="capt"><?php echo ($v["title"]); ?></a>
					                    	<div class="num_btn">
					                    		<span class="num">票数 (<?php echo ($v["num_view"]); ?>)</span>
					                    		<span class="btn post_vote_huihua" onclick="post_vote_huihua(<?php echo ($v["id"]); ?>,0);">投票</span>
					                    	</div>
					                    	<div class="data">
...
<script type="text/javascript" src="/template/Index/NewCommon/js/cascade.js" ></script>
