...
<style>
    ...
    outline: none;
		...
		<div class="warp" style="padding-top:0.3rem;">
			<form action="<?php echo U('Huihua/IndexHuihua/shangchuan');?>" method="post" id="up_form" enctype="multipart/form-data">
			  <input name="id" type="hidden" value="<?php echo ($_GET['id']); ?>">
			  <input name="stage" type="hidden" value="<?php echo ($_GET['stage']); ?>">
			...
			<div class="explain">
				...
				3.请点击<a href="<?php echo U('archives/index_arctype/index',array('t_id'=>71));?>">月历下载</a>
			</div>
					...
					function sumitImageFile(){
					    ...
					    $.ajax({
					        ...
					        success:function(data){
					        	...
					        	location.href="/jtjk/index.php?m=Huihua&c=IndexHuihua&a=index";
					        },
